# README SEO-оптимизация + сравнение конкурентов — ЧЕРНОВИК

> 📄 Вычитка идёт в `interviews/interview_019_readme_seo_review.md` (2026-08-02): там же артефакт
> привязан к sha256 этого файла — правка текста после одобрения аннулирует одобрение.
...
> конкурентов. Сырьё по конкурентам — `researches/competitors/`.
...
> ⚠️ Цифры/статусы — на момент research 2026-06-29 (см. `researches/competitors/*`), перед

...
4. **В каких единицах показывать число** — отдельный вопрос вкуса: сырое значение камеры честно, но
   нечитаемо (экспозиция придёт в единицах 0.0001 с, §2.3). Кандидат — человеческие единицы рядом с
   сырым. Решается мокапом в фазе UI, не агентом.

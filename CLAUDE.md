...
Проект обвязан фреймворком **KAIF 1.4** (см. `KAIF_FRAMEWORK.md`). Канон здесь НЕ дублируется —
...
5. **`EXPERIENCE.md`** — журнал уроков агента: вспомни (grep по тегу) до задачи, зафиксируй урок после
   значимого успеха/провала (навык `/experience`).
6. Карты: `PROJECT_STRUCTURE_EXTERNAL_MAP.md` (где что лежит) и

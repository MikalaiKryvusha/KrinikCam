...
Что сделано: компоновщику/фильтру отдаётся КОПИЯ битмапа слоя, а не тот же объект (его рециклили) —
краш «recycled bitmap» при reorder устранён.
Как проверено: сборка + устройство, перестановка слоёв без краша. Подтверждено в сессии 2026-06-29.

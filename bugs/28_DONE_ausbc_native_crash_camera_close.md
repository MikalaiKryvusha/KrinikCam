...
Починено: `virtual-camera off` персистит → старт сразу на реальной камере, свитча virtual→UVC с провалом негоциации 2K нет → нативный краш AUSBC на close исчез.

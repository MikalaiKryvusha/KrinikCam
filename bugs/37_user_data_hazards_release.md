...
## Статус
🟡 №1/№3/№4 ЗАКРЫТЫ (2026-07-18). Остаток: **№2 keystore** — ждёт решения Криника
(interview_009 + homeworks/06, потеря ключа = конец обновлений навсегда) и «Смежное» (valueOf-краш,
дефолтные URL платформ, импорт на main thread) — по плану plans/12.

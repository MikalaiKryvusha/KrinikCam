...
13. Развил/переделал фичу — синхронно обнови раздел **User Manual** (встроенное руководство, Idea 32 /
...
Проект обвязан **KAIF 1.1** (Krinik AI Framework, https://github.com/MikalaiKryvusha/KAIF) — методологией,
которая РОДИЛАСЬ в этом проекте и вернулась сюда формально оформленной. Сводка развёртывания —
`KAIF_FRAMEWORK.md`; маркер — `.kaif/kaif.json`; ручки — `node tools/kaif.mjs <version|check|...>`.

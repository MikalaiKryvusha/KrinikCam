...
7. Прочитать нужный план из plans/    # если задача связана с конкретной фичей
8. Запустить build (если трогаешь код)# JAVA_HOME=AS_JBR node tools/build.mjs --no-ui
9. Для тестирования приложения — ОБЯЗАТЕЛЬНО загляни в `tools/UI_AUTOMATION_GUIDE.md` и активно
...
10. Обязательное комментирование кода, отдельных его блоков, классов, модулей, важных строк.
11. Сбор знаний, обдумывание и рефлексия по багам, которые фикшу, в отдельных md файлах по каждому багу в директории bugs. Руководствоваться гайдлайном BUG_FIXING_FRAMEWORK.md при фиксинге багов.
12. Зафиксировать опыт                # после значимого успеха/провала — короткий урок в EXPERIENCE.md (навык /experience)
13. Регулярно перечитывать ключевые гайдлайн документы:
...
Проект обвязан **KAIF 1.4** (Krinik AI Framework, https://github.com/MikalaiKryvusha/KAIF) — методологией,
...
**Навыки (22):** сессия `/resume` `/pause` · автономия `/autoloop` `/dayloop` `/nightloop` · гигиена

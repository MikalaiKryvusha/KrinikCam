...
> ⚠️ **ПОДТВЕРЖДЕНИЕ ОБЯЗАТЕЛЬНО.** Перед самим выпуском (шаг 6) покажи Кринику: какая версия будет
...
сделано и проверено (сверься со `STATUS.md` и закрытыми `bugs/`*_DONE_*, `plans/ideas/`*_DONE_*).
...
## Шаг 6. Выпуск (после подтверждения Криника)

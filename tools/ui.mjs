...
switch (cmd) {
  ...
  case 'cmd': {
    ...
    //   node tools/ui.mjs cmd scene-transition <id> <none|fade|slide> <мс>  — переход сцены (plans/18 Ф2)

...
| What | Fixed decision |
|---|---|
| **Selecting an answer** | Hand-written mechanic on top of a radio input: a second click on the chosen option DESELECTS it. A native radio cannot do this, and partial answering is the normal mode — the owner starts answering and defers. Never ship a page where "none of them" is unreachable |
